...
const CURATED_PROJECTS = {
  ...
  "DataAnalyst-LapisAI": {
    ...
    details:
      "A complete conversational data intelligence platform. Enables users to upload datasets and ask analytical queries in natural language. Utilizes Groq (LLaMA 3.3-70B) and Google Gemini (Flash Lite) for NL-to-SQL execution, with real-time SVG charting, security guardrails, and dynamic PDF/PNG reports generation.",
    features: [
      "Asynchronous React 19 / Vite client with Zustand state management",
      "FastAPI API engine with Pydantic schema validation and Bcrypt security",
      "LangChain Groq (LLaMA 3.3) & Gemini core intelligence with SQL Safety Guardrails",
      "Dynamic interactive charting using Recharts and high-res PDF/PNG reports exporter",
      "Database integration using Supabase SDK and transaction-safe PostgreSQL",
    ],
